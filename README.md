...
Hi! Mein Interesse konzentriert sich auf die Entwicklung innovativer Lösungen, die es ermöglichen, große Datenmengen effizient zu analysieren und daraus wertvolle Erkenntnisse zu gewinnen. Zudem stehe ich gerne beratend zur Seite, wenn es um die Konzeption oder Anforderungen von Anwendungen geht.

Fachliche Interessen:
- Natural Language Processing (ML, AI)
- Data Science
- Data Literacy
- Gegenwärtige Themen der Digitalisierung
- Projektmanagement
